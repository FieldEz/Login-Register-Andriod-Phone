...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  Future doRegister() async {
    try {
      var rs = await apiProvider.doRegister(_ctrlUsername.text,
          _ctrlPassword.text, _ctlFullname.text, _ctrlEmail.text);
...
//redirect
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      backgroundColor: Color(0xFF9AFF8A),
